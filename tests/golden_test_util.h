...
#ifndef D3DSW_GOLDEN_DIR
#define D3DSW_GOLDEN_DIR "."
#endif

#ifndef D3DSW_OUTPUT_DIR
#define D3DSW_OUTPUT_DIR "."
#endif

#ifndef D3DSW_SHADER_DIR
#define D3DSW_SHADER_DIR "."
#endif
...
{
    std::string refDir  = D3DSW_GOLDEN_DIR;
    std::string refPath = refDir + "/" + testName + ".ppm";

    std::string outDir = D3DSW_OUTPUT_DIR;

    bool updateGolden = false;
    if (const char* env = std::getenv("D3DSW_UPDATE_GOLDEN"))
