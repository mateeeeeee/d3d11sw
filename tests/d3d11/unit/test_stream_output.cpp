...
TEST_F(SOTests, CaptureAndReadBack)
{
    ...
    auto vsBytecode = ReadFile(D3DSW_SHADER_DIR "/vs_color.o");
    ...
    auto gsBytecode = ReadFile(D3DSW_SHADER_DIR "/gs_passthrough.o");
    ...
    auto psBytecode = ReadFile(D3DSW_SHADER_DIR "/ps_color.o");
...
TEST_F(SOTests, MultiStream)
{
    ...
    auto gsBytecode = ReadFile(D3DSW_SHADER_DIR "/gs_multi_stream.o");
