...
TEST_F(DrawGoldenTests, CombinedPsSwitchMapBgraMultiCbuf64x64)
{
    ...
    auto vsBlob = ReadBytecode(D3DSW_SHADER_DIR "/vs_multi_cbuf.o");
    auto psTexBlob = ReadBytecode(D3DSW_SHADER_DIR "/ps_combined_textured.o");
    auto psSolidBlob = ReadBytecode(D3DSW_SHADER_DIR "/ps_combined_solid.o");
