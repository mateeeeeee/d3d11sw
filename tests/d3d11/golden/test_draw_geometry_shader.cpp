...
TEST_F(DrawGoldenTests, GeometryShader64x64)
{
    ...
    auto gsBytecode = ReadBytecode(D3DSW_SHADER_DIR "/gs_explode.o");
    ...
    auto result = CheckGolden("draw_geometry_shader_64x64", pixels.data(), W, H, 0.0f);
    ...
    EXPECT_GT(coloredPixels, 50) << "Expected pixels written by geometry shader";
