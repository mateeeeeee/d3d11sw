...
TEST_F(CSGoldenTests, Texture8x8)
{
    // 8x8 R8G8B8A8_UNORM gradient: R=x*32, G=y*32, B=128, A=255
    ...
    // 8x8 R32G32B32A32_FLOAT RWTexture2D
    ...
    auto bytecode = ReadBytecode(D3DSW_SHADER_DIR "/cs_texture.o");
    ...
    auto result = CheckGolden("cs_texture_8x8", pixels, 8, 8, 0.01f);
