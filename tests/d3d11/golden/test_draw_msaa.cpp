...
TEST_F(DrawGoldenTests, MSAA4x64x64)
{
    ...
    auto result = CheckGolden("draw_msaa_4x_64x64", pixels.data(), W, H, 0.0f);
    ...
    EXPECT_GT(fullRed, 50) << "Expected solid interior pixels";
    EXPECT_GT(partialRed, 10) << "Expected anti-aliased edge pixels from MSAA resolve";
