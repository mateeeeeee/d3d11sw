...
struct CSDispatchIndirectGoldenTests : ::testing::Test
{
...
TEST_F(CSDispatchIndirectGoldenTests, DispatchIndirect8x8)
{
    ...
    auto bytecode = ReadBytecode(D3DSW_SHADER_DIR "/cs_solid_fill.o");
    ...
    auto result = CheckGolden("cs_dispatch_indirect_8x8", pixels, 8, 8, 0.0f);
