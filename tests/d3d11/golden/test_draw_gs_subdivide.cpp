...
TEST_F(DrawGoldenTests, GSSubdivide64x64)
{
    ...
    float vertices[] = {
         ...
         0.8f, -0.6f, 0.5f,   0.f, 0.f, 1.f, 1.f,
        -0.8f, -0.6f, 0.5f,   0.f, 1.f, 0.f, 1.f,
    };
    ...
    auto gsBytecode = ReadBytecode(D3DSW_SHADER_DIR "/gs_subdivide.o");
    ...
    auto result = CheckGolden("draw_gs_subdivide_64x64", pixels.data(), W, H, 0.0f);
    ...
    EXPECT_GT(coloredPixels, 500) << "Subdivided triangle should cover significant area";
