...
TEST_F(DrawGoldenTests, GSAmplify64x64)
{
    ...
    auto gsBytecode = ReadBytecode(D3DSW_SHADER_DIR "/gs_amplify.o");
    ...
    auto result = CheckGolden("draw_gs_amplify_64x64", pixels.data(), W, H, 0.0f);
    ...
    EXPECT_GT(redPx, 20)   << "Expected red-tinted triangle copy";
    EXPECT_GT(greenPx, 20) << "Expected green-tinted triangle copy";
    EXPECT_GT(bluePx, 20)  << "Expected blue-tinted triangle copy";
