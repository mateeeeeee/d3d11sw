...
TEST_F(DrawGoldenTests, GSPointToQuad64x64)
{
    ...
    float vertices[] = {
        -0.5f,  0.3f, 0.5f,   1.f, 0.f, 0.f, 1.f,
         ...
         0.0f, -0.4f, 0.5f,   0.f, 0.f, 1.f, 1.f,
    };
    ...
    auto gsBytecode = ReadBytecode(D3DSW_SHADER_DIR "/gs_point_to_quad.o");
    ...
    auto result = CheckGolden("draw_gs_point_to_quad_64x64", pixels.data(), W, H, 0.0f);
    ...
    EXPECT_GT(redPx, 30)   << "Expected red quad from point 0";
    EXPECT_GT(greenPx, 30) << "Expected green quad from point 1";
    EXPECT_GT(bluePx, 30)  << "Expected blue quad from point 2";
