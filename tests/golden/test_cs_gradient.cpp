...
// cs_gradient.hlsl — loaded at runtime from D3D11SW_SHADER_DIR/cs_gradient.o
...
TEST_F(CSGoldenTests, Gradient8x8)
{
    ...
    auto bytecode = ReadBytecode(D3D11SW_SHADER_DIR "/cs_gradient.o");
    ...
    auto result = CheckGolden("cs_gradient_8x8", pixels, 8, 8, 0.01f);
