...
TEST_F(CSGoldenTests, IntegerMath8x8)
{
    ...
    auto bytecode = ReadBytecode(D3D11SW_SHADER_DIR "/cs_integer_math.o");
    ...
    auto result = CheckGolden("cs_integer_math_8x8", pixels, 8, 8, 0.01f);
