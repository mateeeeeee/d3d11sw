...
// cs_loop.hlsl — loaded at runtime from D3D11SW_SHADER_DIR/cs_loop.o
...
TEST_F(CSGoldenTests, Loop8x8)
{
    ...
    auto bytecode = ReadBytecode(D3D11SW_SHADER_DIR "/cs_loop.o");
    ...
    auto result = CheckGolden("cs_loop_8x8", pixels, 8, 8, 0.01f);
