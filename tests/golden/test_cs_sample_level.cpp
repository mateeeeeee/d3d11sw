...
TEST_F(CSGoldenTests, SampleLevel8x8)
{
    const UINT W = 4, H = 4;

    unsigned char mip0[W * H * 4];
    ...
    auto bytecode = ReadBytecode(D3D11SW_SHADER_DIR "/cs_sample_level.o");
    ...
    auto result = CheckGolden("cs_sample_level_8x8", pixels, 8, 8, 0.02f);
