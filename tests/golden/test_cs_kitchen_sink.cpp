...
TEST_F(CSGoldenTests, KitchenSink8x8)
{
    float cbData[4] = { 0.5f, 0.5f, 0.0f, 0.0f };
    ...
    auto bytecode = ReadBytecode(D3D11SW_SHADER_DIR "/cs_kitchen_sink.o");
    ...
    auto result = CheckGolden("cs_kitchen_sink_8x8", pixels, 8, 8, 0.01f);
