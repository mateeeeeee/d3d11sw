...
// cs_cbuffer.hlsl — loaded at runtime from D3D11SW_SHADER_DIR/cs_cbuffer.o
...
TEST_F(CSGoldenTests, CBuffer8x8)
{
    ...
    // Create constant buffer with known color (0.2, 0.8, 0.5, 1.0)
    float cbData[4] = { 0.2f, 0.8f, 0.5f, 1.0f };

    D3D11_BUFFER_DESC cbDesc = {};
    cbDesc.ByteWidth      = 16;  // one float4
    ...
    // Load shader
    auto bytecode = ReadBytecode(D3D11SW_SHADER_DIR "/cs_cbuffer.o");
    ...
    auto result = CheckGolden("cs_cbuffer_8x8", pixels, 8, 8, 0.01f);
