...
// cs_multi_group.hlsl — loaded at runtime from D3D11SW_SHADER_DIR/cs_multi_group.o
...
TEST_F(CSGoldenTests, MultiGroup8x8)
{
    ...
    auto bytecode = ReadBytecode(D3D11SW_SHADER_DIR "/cs_multi_group.o");
    ...
    // Dispatch 2x2x1 groups of 4x4x1 threads = 8x8 total
    ...
    auto result = CheckGolden("cs_multi_group_8x8", pixels, 8, 8, 0.01f);
