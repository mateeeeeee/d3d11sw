...
// cs_checkerboard.hlsl — loaded at runtime from D3D11SW_SHADER_DIR/cs_checkerboard.o
...
TEST_F(CSGoldenTests, Checkerboard8x8)
{
    ...
    auto bytecode = ReadBytecode(D3D11SW_SHADER_DIR "/cs_checkerboard.o");
    ...
    auto result = CheckGolden("cs_checkerboard_8x8", pixels, 8, 8, 0.0f);
