...
class MarsDeviceContext;

class MarsDevice : public UnknownImpl<ID3D11Device5, ID3D11Device4, ID3D11Device3, ID3D11Device2, ID3D11Device1, ID3D11Device>
{
public:
    MarsDevice();
    ~MarsDevice() override;

    void SetImmediateContext(MarsDeviceContext* ctx);
...
protected:
    MarsDeviceContext* m_immediateContext = nullptr;
};
