...
inline D3DSW_RESOURCE_INFO GetSWResourceInfo(ID3D11Resource* pResource)
{
...
inline D3DSW_SUBRESOURCE_LAYOUT GetSwSubresourceLayout(ID3D11Resource* pResource, Uint subresource)
{
    D3D11_RESOURCE_DIMENSION dim = D3D11_RESOURCE_DIMENSION_UNKNOWN;
    pResource->GetType(&dim);
    switch (dim)
...
inline D3D11_RENDER_TARGET_VIEW_DESC1 MakeDefaultRTVDesc(const D3DSW_RESOURCE_INFO& info)
{
...
inline D3D11_DEPTH_STENCIL_VIEW_DESC MakeDefaultDSVDesc(const D3DSW_RESOURCE_INFO& info)
{
...
inline D3D11_SHADER_RESOURCE_VIEW_DESC1 MakeDefaultSRVDesc(const D3DSW_RESOURCE_INFO& info)
{
...
inline D3D11_UNORDERED_ACCESS_VIEW_DESC1 MakeDefaultUAVDesc(const D3DSW_RESOURCE_INFO& info)
{
