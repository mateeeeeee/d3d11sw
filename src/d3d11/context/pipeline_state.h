...
using D3DSW_PIPELINE_STATISTICS = SWPipelineStatistics;

struct D3DSW_PIPELINE_STATE
{
    //IA
    ...
    D3DSW_PIPELINE_STATISTICS stats;

    void ReleaseAll();
};

void BuildSWPipelineState(D3DSW_PIPELINE_STATE& in, SWPipelineState& out);
