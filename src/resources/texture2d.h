...
class Direct3D11Texture2DSW : public DeviceChildImpl<ID3D11Texture2D1, ID3D11Texture2D, ID3D11Resource, ID3D11DeviceChild>
{
public:
    explicit Direct3D11Texture2DSW(ID3D11Device* device);
