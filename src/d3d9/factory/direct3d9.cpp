...
HRESULT STDMETHODCALLTYPE D3D9SW::CheckDeviceType(UINT, D3DDEVTYPE, D3DFORMAT, D3DFORMAT, WINBOOL) { return S_OK; }
HRESULT STDMETHODCALLTYPE D3D9SW::CheckDeviceFormat(UINT, D3DDEVTYPE, D3DFORMAT, DWORD, D3DRESOURCETYPE, D3DFORMAT) { return S_OK; }
HRESULT STDMETHODCALLTYPE D3D9SW::CheckDeviceMultiSampleType(UINT, D3DDEVTYPE, D3DFORMAT, WINBOOL, D3DMULTISAMPLE_TYPE, DWORD*) { return D3DERR_NOTAVAILABLE; }
