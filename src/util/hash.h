...
namespace d3d11sw
{
    ...
    namespace crc
    {
        ...
        constexpr Uint64 crc64_impl(Char const* str, Uint64 N)
        {
    ...
    template<Uint64 N>
    consteval Uint64 crc64(Char const (&str)[N])
    {
        return crc::crc64_impl(str, N - 1);
    }

    inline Uint64 crc64(Char const* str, Uint64 N)
    {
        return crc::crc64_impl(str, N);
    }
}
